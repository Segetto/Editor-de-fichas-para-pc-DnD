...
public class MagiasPanelP {
    ...
    public static void MagiaPanelP(String personagemCaminho, JSONObject ficha, JPanel PainelCaracteristicas, String VetorNome, JPanel PainelMagias) {
        ...
        for (int i = 0; i < ficha.getJSONArray(VetorNome).length(); i++) {
            ...
            JLabel NomeItem = new JLabel(ficha.getJSONArray(VetorNome).getJSONObject(i).getJSONObject("b").getString("d"));
            ...
            JLabel DescricaoItem = new JLabel("<html><div style='width: 304px; padding: 7px;'>" + ficha.getJSONArray(VetorNome).getJSONObject(i).getJSONObject("b").getString("e") + "</div></html>");
            ...
            PainelNomeItem.addMouseListener(new MouseAdapter() {
                ...
                public void mouseClicked(MouseEvent e) {
                    ...
                    if (PainelDescricaoItem.getParent() != null) {
                        ...
                        for (Component comp : PainelMagias.getComponents()) {
                        ...
                        PainelMagias.setPreferredSize(new Dimension(PainelMagias.getWidth(), (heightChange + HeightInicialJanela)));
                    } else {
        ...
        PainelMagias.setPreferredSize(new Dimension(PainelMagias.getWidth(), height + HeightInicialJanela));
