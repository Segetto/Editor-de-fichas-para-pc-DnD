...
import org.json.*;
import backend.Fun.Par.Magias.EditMagia;
import javax.swing.*;
import java.awt.*;
 ...
 * @author Admin
 */
public class EditarMagia extends javax.swing.JFrame {

    /**
     * Creates new form CriarItem
     */
    public EditarMagia(JSONObject magia, JSONArray classes, JLabel EditMagiaJ) {
        initComponents();
        Nome.setText(magia.getString("b"));
        Escola.setText(magia.getString("d"));
        Duracao.setText(magia.getString("e"));
        Tempo.setText(magia.getString("f"));
        Alcance.setText(magia.getString("g"));
        Componentes.setText(magia.getString("i"));
        Descricao.setText(magia.getString("c"));
        EditMagia.EditMagia(classes, magia, Nome, Escola, Duracao, Tempo, Alcance, Componentes, Descricao, EditMagiaLabel, ClassesLabel, AddClasses, EditMagiaJ);
    ...
    private void initComponents() {
        ...
        EditMagiaLabel = new javax.swing.JLabel();
        ...
        EditMagiaLabel.setForeground(new java.awt.Color(122, 255, 255));
        EditMagiaLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        EditMagiaLabel.setText("Adicionar");
        EditMagiaLabel.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(23, 23, 23)
                .addComponent(EditMagiaLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 72, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(BotaoSair)
                    .addComponent(EditMagiaLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(23, 23, 23))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditarMagia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel EditMagiaLabel;
